        ...
        <section className="w-full min-h-[55vh] flex flex-col items-center justify-center px-4 py-12">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-7xl">
                <div className="flex-shrink-0 flex items-center justify-center">
                    {/* <div className="rounded-full w-40 h-40 bg-gradient-to-br from-blue-500 to-purple-600 border-4 border-[var(--color-primary)] shadow-lg flex items-center justify-center text-white text-4xl font-bold">
                        ED
                    </div> */}
                ...
                <div className="bg-gradient-to-br  rounded-2xl  p-8 flex flex-col gap-6 w-full max-w-xl">
                    <div className="text-xl md:text-2xl text-[var(--color-primary)]">
                        <h1 className="text-xl md:text-2xl">
                            Hi! I'm Ermiyas Damte,<span role="img" aria-label="wave">👋</span>
                        </h1>
                        <h2 className="block mt-2 font-extrabold text-xl md:text-xl">Fullstack Developer & UI/UX Designer</h2>
                        <p className="pl-0 font-normal text-[var(--color-primary)] text-xs md:text-sm space-y-1 mt-2">
